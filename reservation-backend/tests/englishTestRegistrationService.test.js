...
describe('englishTestRegistrationService — cross-semester', () => {
  ...
  describe('inferRegistrationSemester', () => {
    ...
    it('does not fall back to active semester for unmapped createdAt', () => {
      const reg = buildRegistration({
        semester: null,
        createdAt: new Date('2020-01-01'),
      });
      expect(inferRegistrationSemester(reg, { atDate: new Date('2026-10-01') })).toBeNull();
      expect(inferRegistrationSemester(reg, {
        atDate: new Date('2026-10-01'),
