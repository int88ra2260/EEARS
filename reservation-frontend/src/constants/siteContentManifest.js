...
export const SITE_CONTENT_KEY_SUGGESTIONS = {
  ...
  activities: [
    ...
    { key: 'activities.englishTableImageUrl', label: 'English Table 卡片圖片（空白＝預設）' },
    { key: 'activities.englishClubImageUrl', label: 'English Club 卡片圖片（空白＝預設）' },
    { key: 'activities.jobTalkImageUrl', label: 'Job Talk 卡片圖片（空白＝預設）' },
    { key: 'activities.writingWorkshopImageUrl', label: 'Writing Workshop 卡片圖片（空白＝預設）' },
    { key: 'activities.englishTableSecondaryCtaLabel', label: 'English Table 第二按鈕名稱（空白＝不顯示）' },
    { key: 'activities.englishTableSecondaryCtaUrl', label: 'English Table 第二按鈕網址' },
    { key: 'activities.englishClubSecondaryCtaLabel', label: 'English Club 第二按鈕名稱（空白＝不顯示）' },
    { key: 'activities.englishClubSecondaryCtaUrl', label: 'English Club 第二按鈕網址' },
    { key: 'activities.jobTalkSecondaryCtaLabel', label: 'Job Talk 第二按鈕名稱（空白＝不顯示）' },
    { key: 'activities.jobTalkSecondaryCtaUrl', label: 'Job Talk 第二按鈕網址' },
    { key: 'activities.writingWorkshopSecondaryCtaLabel', label: 'Writing Workshop 第二按鈕名稱（空白＝不顯示）' },
    { key: 'activities.writingWorkshopSecondaryCtaUrl', label: 'Writing Workshop 第二按鈕網址' },
  ...
  contact: [
    { key: 'homePage.contactTitle', label: '聯絡區塊標題' },
    { key: 'homePage.contactLead', label: '聯絡區塊導言' },
