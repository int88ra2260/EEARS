...
export const COURSE_GUIDE_SOURCE_LINKS = [
  {
    labelZh: '修課說明與入學門檻（總覽頁）',
    labelEn: 'Course guide & graduation threshold (overview)',
    href: 'https://emicenter.siwan.nsysu.edu.tw/graduation-threshold',
  },
  {
    labelZh: '以英語文測驗抵免課程資格（抵免標準）',
    labelEn: 'Credit waiver by English test scores',
    href: 'https://emicenter.siwan.nsysu.edu.tw/graduation-threshold/1/2',
  },
  {
    labelZh: '英語能力標準認證（認證說明）',
    labelEn: 'English proficiency certification',
    href: 'https://emicenter.siwan.nsysu.edu.tw/graduation-threshold/1/4',
  },
  {
    labelZh: '英語實踐歷程檔案（點數計算與申請）',
    labelEn: 'English practice portfolio (points & application)',
    href: 'https://emicenter.siwan.nsysu.edu.tw/graduation-threshold/1/5',
  },
];

export const COURSE_GUIDE_DEFAULT = {
  pageTitleZh: '修課說明',
...
export default COURSE_GUIDE_DEFAULT;
