/**
 * Vocabulary Size 人工策展種子詞（build 時併入 generated 詞庫）
 * @typedef {{ word: string, band: number, rank: number }} FrequencyWordSeed
 */

/** @type {FrequencyWordSeed[]} */
export const FREQUENCY_WORD_BANK_SEEDS = [
